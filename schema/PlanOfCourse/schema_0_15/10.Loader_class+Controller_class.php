...
-
- Loader Class
- This is responsible for loadinf Controllers " Classes" AND Models "Classes" located  in App directory
-
- Properties
-
...
-
- Methods
- public mixed    Loader::action(string $controller , string $method , array $arguments) Loader a class and call a method from it then pass the given arguments to it
- public object|  Loader::controller(string $controller) Load the given controller class and store it in controllers container
- private bool    Loader::hasController(string $controller) Determine if the given controller exists in controller container
...
- private bool    Loader::hasModel(string $model) Determine if the given controller exists in model container
