...
class  UsersGroupsController extends Controller
{
	   ...
	   public function index()
     {
          ...
          // pred($this->load->model('UsersGroups')->get(1));
     ...
     private  function getPermissionPages()
     {
          ...
          foreach ($this->route->routes() as $route) { //  pre($route);
     ...
     private function isValid(){
         ...
         return $this->validator->passes(); // or validate()->passes()
     }
