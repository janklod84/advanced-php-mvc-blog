...
<!-- /.content-wrapper -->
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2018 <a href="http://www.aymanelash.com">Ayman Elash</a>.</strong> All rights
    reserved.
  </footer>
                ...
                <form action="<?php echo url('/admin/profile/update'); ?>" class="form-modal form">
                 ...
                 <div class="form-group col-sm-6">
                  ...
                  <div class="form-group col-sm-6">
                    ...
                    <input type="text" name="birthday" id="birthday" class="form-control" placeholder="Birthday" value="<?php echo $user->birthday; ?>">
                 </div>
                 ...
                 <?php if($user->image): ?>
                   <div class="form-group col-sm-12">
                     <img src="<?php echo assets('images/'. $user->image); ?>" style="width:90px;" alt="">
                   </div>
                 <?php endif; ?>
...
<script>
   ...
   // $(function(){ });
       ...
       var segment = currentUrl.split('/').pop(); //console.log(segment);

       // 3- Add the "active" class to the id in the sidebar of the current url
       $('#' + segment + '-link').addClass('active'); 
       //console.log($('#' + segment + '-link').length);
   ...
   // SUBMIT BTN
   $(document).on('click', '.submit-btn', function(e){ // function(e)

         btn = $(this);  

         // obtain data from CKEditor : alert(CKEDITOR.instances.details.getData());
         ...
         if(form.find('#details').length){
             ...
             // then add the value for it to be gotten from cheditor
