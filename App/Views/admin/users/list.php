          ...
          <div class="col-sm-12">
              <div class="box" id="users-list">
                <div class="box-header with-border">
                  ...
                  <button class="btn btn-danger pull-right open-popup" type="button" data-modal-target="#add-user-form
                  " data-target="<?php echo url('/admin/users/add'); ?>">Add New User</button>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                 <div id="results"></div>
                  <table class="table table-bordered">    
                    ...
                    <tr>
                      ...
                      <td style="vertical-align: middle;">
                        <?php echo date('d-m-Y', $user->created); ?>
                      ...
                      <td style="vertical-align: middle;">
                       ...
                       <?php if($user->id != 1) :?>
                        <button  type="button" data-target="<?php echo url('admin/users/delete/' . $user->id); ?>" class="btn btn-danger delete">      Delete
