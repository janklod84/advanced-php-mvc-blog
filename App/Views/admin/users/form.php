                ...
                <form action="<?php echo $action; ?>" class="form-modal form">
                   ...
                   <select name="users_group_id" class="form-control" id="users_group_id">
                    <?php foreach($users_groups as $users_group) : ?>
                       <option value="<?php echo $users_group->id; ?>" 
                        <?php echo $users_group->id == $users_group_id ? 'selected' : false; ?>>
                 ...
                 <div class="form-group col-sm-6">
                  ...
                  <div class="form-group col-sm-6">
                    ...
                    <input type="text" name="birthday" id="birthday" class="form-control" placeholder="Birthday" value="<?php echo $birthday; ?>">
                 </div>
