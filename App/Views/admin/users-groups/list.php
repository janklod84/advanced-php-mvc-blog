          ...
          <div class="col-sm-12">
              <div class="box" id="users-list">
                <div class="box-header with-border">
                  ...
                  <button class="btn btn-danger pull-right open-popup" type="button" data-modal-target="#add-users-group-form
                  " data-target="<?php echo url('/admin/users-groups/add'); ?>">Add New Users Group</button>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                 <div id="results"></div>
                  <table class="table table-bordered">    
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <button  type="button" data-target="<?php echo url('admin/users-groups/delete/' . $users_group->id); ?>" class="btn btn-danger delete">      Delete
